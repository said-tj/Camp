# ============================================================
# CÓDIGO PARA GRÁFICA DE DURACIÓN
# ============================================================
...
# Guardar resultados
write.csv(resultados_anova, "resultados_anova_duracion.csv", row.names = FALSE)
write.csv(resultados_tukey, "resultados_tukey_duracion.csv", row.names = FALSE)
